...
int main() {
	...
	RGB = GetPixel(DC, 1000, 1000);
	/*ShellExecute(Window, NULL, "C:\\Users\\Daniel\\AppData\\Local\\Roblox\\Versions\\version-55d6e65f478642a8\\RobloxPlayerBeta.exe", "-l", NULL, SW_HIDE);
	Sleep(1500);
	while (RGB == GetPixel(DC, 1000, 1000)) {
		Sleep(1);
	};*/
	Sleep(1000);
	keybd_event('W', 0x1D, 0, 0);
	Sleep(1500);
	keybd_event('W', 0x1D, KEYEVENTF_KEYUP, 0);
	ReleaseDC(NULL, DC);
